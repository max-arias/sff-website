-- ============================================================================
-- SFF Builder v2 — Compensate missing base schema before PSU tier deploy
--
-- Production may have 0001_initial.sql marked as applied from an earlier deploy
-- while the per-kind tables are absent. Wrangler will not replay an applied
-- migration by filename, so this pending migration must be able to create the
-- required schema itself. All statements are idempotent for already-created
-- tables.
-- ============================================================================

...
function renderComponentRoot$1(instance) {
	...
	try {
		if (vnode.shapeFlag & 4) {
			...
			result = normalizeVNode$1(render.call(thisProxy, proxyToUse, renderCache, props, setupState, data, ctx));
			fallthroughAttrs = attrs;
		} else {
			const render2 = Component;
			result = normalizeVNode$1(render2.length > 1 ? render2(props, {
				attrs,
				slots,
				emit
			}) : render2(props, null));
...
//#endregion
export { includeBooleanAttr as _, ssrRenderClass as a, createSSRApp as c, h as d, mergeProps as f, ref as g, watch as h, ssrRenderAttrs as i, computed as l, useSSRContext as m, ssrInterpolate as n, ssrRenderList as o, onMounted as p, ssrRenderAttr as r, ssrRenderStyle as s, renderToString as t, defineComponent as u };
